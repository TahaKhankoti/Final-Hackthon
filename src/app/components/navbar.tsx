...
import user from "@/src/images/Vector (12).png";
import search from "@/src/images/icn settings icn-xs (6).png";
import cart from "@/src/images/icn settings icn-xs (7).png";
import mail from "@/src/images/icn settings icn-xs (8).png";

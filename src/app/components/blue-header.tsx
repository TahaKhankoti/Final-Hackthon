...
import phone from "@/src/images/icn settings icn-xs.png"
import mail from "@/src/images/icn settings icn-xs (1).png";
import insta from "@/src/images/icn settings icn-xs (2).png";
import yout from "@/src/images/icn settings icn-xs (3).png";
import fb from "@/src/images/icn settings icn-xs (4).png";
import twit from "@/src/images/icn settings icn-xs (5).png";
